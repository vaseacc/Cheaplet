export function getFirebaseConfig(env, hostname, customAuthDomain) {
  ...
  if (customAuthDomain) {
    ...
    // For custom domains like scoralia.ca, use chaeplet.firebaseapp.com as authDomain
    // This ensures the redirect_uri matches the Firebase Console configuration
